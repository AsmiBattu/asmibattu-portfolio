  ...
  return (
    <section id="work-grid" className="scroll-mt-12 mb-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div 
          data-cursor="view" 
          onClick={() => handleNavigate && handleNavigate("casestudy", "top", "unlockr")}
          ...
          <div className="p-6 md:p-8 flex-grow flex flex-col justify-between">
            ...
            <div className="flex justify-between items-center pt-4 border-t border-[#F2F1EC]">
              <a
                href="#"
                onClick={(e) => { e.preventDefault(); handleNavigate && handleNavigate("casestudy", "top", "unlockr"); }}
        ...
        {/* Project 2: LabBuddy Screens Redesign */}
        <div 
          data-cursor="view" 
